...
[`vignette("choosing-between-methods")`](https://kennethataylor.github.io/mccount/dev/articles/choosing-between-methods.md)
and
[`?mcc`](https://kennethataylor.github.io/mccount/dev/reference/mcc.md)
for more details.
...
[`vignette("estimating-mcc-after-matching-or-weighting")`](https://kennethataylor.github.io/mccount/dev/articles/estimating-mcc-after-matching-or-weighting.md)
for more details.
