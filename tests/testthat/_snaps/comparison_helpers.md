...
# compare_groups handles 3+ groups with default reference
    ...
    Message
      ...
      i Comparison of A and C truncated at time 6
...
# compare_groups performs all pairwise comparisons
    ...
    Message
      ...
      i Comparison of B and C truncated at time 6
    Condition
      Warning:
...
# compare_groups handles division by zero in MCCR
    ...
    Message
      ...
      i Comparison of A and B truncated at time 1
    Condition
      Warning:
      ! Reference group MCC = 0 at 1 time point
